						...
						<form
							...
							<div className="flex flex-wrap gap-1 ">
								...
								<div className="flex gap-2 w-full justify-center pt-3">
									<div
										className="bg-neutral-950 text-white py-2 px-8 w-full  rounded-lg whitespace-nowrap transition duration-100 hover:bg-neutral-900 flex  items-center justify-center"
										onClick={handleToggle}>
										<ArrowLeftTwoTone />
										Go back
									</div>
									<button
										type="submit"
										className="bg-neutral-950 text-white py-2 px-8 w-full rounded-lg transition duration-100 hover:bg-neutral-900"
