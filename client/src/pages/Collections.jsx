									...
									{savedGames.length < 1 ? (
										...
										<div>
											{savedGames.map((game) => (
												<div
													key={game._id}
													className="h-80 p-5 my-5 bg-neutral-950 flex justify-between items-center rounded-lg">
													<img
														src={game.gameImgUrl}
														alt="image"
													...
													<div className="flex flex-col gap-3">
														...
														<Link to={`/games/${game.gameId}`}>
															<button className="py-3 bg-neutral-800/50 w-full text-white flex gap-2 justify-center transition duration-300 hover:bg-neutral-700/50">
																<SportsEsportsOutlined />
																View game
															</button>
														</Link>
														<a href={game.website} target="blank">
															<button className="py-3 bg-neutral-950/50 w-full text-white flex gap-2 justify-center transition duration-300 hover:bg-neutral-700/50">
																<SportsEsportsOutlined />
																Play game
															</button>
														</a>
